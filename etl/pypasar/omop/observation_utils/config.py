class ObservationMappingConfig():
    ...
    observation_source_value_mapping = {
        "pasar": [
            ("preop.riskindex", ["high_risk_op", "h_o_ihd", "h_o_chf", "h_o_cva", "dm_on_insulin", "hypertension", "history_of_osa", "loud_snoring",
                                 "daytime_tiredness", "apnoea", "cpap_use", "history_of_hypertension", "history_of_motion_sickness", "postop_nausea_smoking_history"]),
            ("preop.others", ["forget_prescribed_medications",
                              "no_of_prior_hospital_admissions", "continence", "inhalation_burns", "tbsa"]),
            ("preop.char", ["smoking_history", "alcohol_consumption", "pregnancy_gender", "presence_of_malignancy",
                            "allergy_information", "physical_general", "physical_cardio", "physical_respiratory"]),
            ("postop.discharge", ["days_postop"]),
            ("postop.info", ["postop_patient_satisfaction",
    ...
    value_source_value_mapping = {
        "pasar": [
            ...
            ("preop.others", ["forget_prescribed_medications",
             "no_of_prior_hospital_admissions", "continence", "inhalation_burns", "tbsa"]),
            ("preop.char", ["allergy_information", "smoking_history", "alcohol_consumption", "pregnancy_gender",
             "presence_of_malignancy", "physical_general", "physical_cardio", "physical_respiratory"]),
            ("postop.discharge", ["days_postop"]),
            ("postop.info", ["postop_patient_satisfaction",
             "satisfaction_at_analgesia_removal"]),
            ("postop.icu", ["resuscitation_status"])
